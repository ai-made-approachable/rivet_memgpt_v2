...
const sharedResults = {
    ...
    indivisible: [521, 452, 12843],
    'hello 👋 world 🌍': [31373, 50169, 233, 995, 12520, 234, 235],
...
const results = {
    cl100k_base: {
        space: [220],
        tab: [197],
        'This is some text': [2028, 374, 1063, 1495],
        indivisible: [485, 344, 23936],
        'hello 👋 world 🌍': [15339, 62904, 233, 1917, 11410, 234, 235],
        decodedHelloWorldTokens: ['hello', ' ', '👋', ' world', ' ', '🌍'],
        'toString constructor hasOwnProperty valueOf': [
            6712, 4797, 706, 19964, 907, 2173,
        ],
        'hello, I am a text, and I have commas. a,b,c': [
            15339, 11, 358, 1097, 264, 1495, 11, 323, 358, 617, 77702, 13, 264,
            8568, 10317,
        ],
    },
...
describe.each(mapping_js_1.encodingNames)('%s', (encodingName) => {
