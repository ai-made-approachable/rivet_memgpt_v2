...
import { getParamNames, zip, getTestCounter } from './utils.mjs';
import { globalRequestBuffer } from './init.mjs';
...
class PipelineRun {
    ...
    checkpoint(step) {
        ...
        if (lastElement) {
            ...
            this.stepRuns.push(new StepRun((_a = step.provider) !== null && _a !== void 0 ? _a : "undeclared", (_b = step.invocation) !== null && _b !== void 0 ? _b : "undeclared", elapsedTime, stepStartTime, endTimeNew, step.inputs, (_c = step.modelParams) !== null && _c !== void 0 ? _c : {}, step.outputs, (_d = step.context) !== null && _d !== void 0 ? _d : {}));
        }
        else {
            const elapsedTime = 0;
            const startAndEndTime = new Date().toISOString();
            this.stepRuns.push(new StepRun((_e = step.provider) !== null && _e !== void 0 ? _e : "undeclared", (_f = step.invocation) !== null && _f !== void 0 ? _f : "undeclared", elapsedTime, startAndEndTime, startAndEndTime, step.inputs, (_g = step.modelParams) !== null && _g !== void 0 ? _g : {}, step.outputs, (_h = step.context) !== null && _h !== void 0 ? _h : {}));
        }
    }
    /**
    ...
    measure(func, inputs, stepInfo) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.stepRuns.push(new StepRun((_a = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.provider) !== null && _a !== void 0 ? _a : "undeclared", (_b = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.invocation) !== null && _b !== void 0 ? _b : "undeclared", elapsedTime, new Date(startTime).toISOString(), new Date(endTime).toISOString(), resolvedInputs, (_c = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.modelParams) !== null && _c !== void 0 ? _c : {}, modifiedOuput, (_d = stepInfo === null || stepInfo === void 0 ? void 0 : stepInfo.context) !== null && _d !== void 0 ? _d : {}));
            return returnValue;
        });
    }
