...
import { Pipeline, constructSubmissionPayload, createTestCase, createTestCases, getPipelines, getTestCases, getTestResults, runTest, submitTestResult, updateTestCase, } from "../providers";
...
describe("Usage of Evaluation functionality", () => {
    ...
    beforeAll(() => {
        ...
        server = setupServer(rest.post("https://gentrace.ai/api/v1/test-result", (req, res, ctx) => {
            ...
            return res(ctx.status(200), ctx.set("Content-Type", "application/json"), ctx.json(getTestResultsResponse));
    ...
    describe("constructor", () => {
        ...
        it("should get all test results", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
            });
            const results = yield getTestResults("guess-the-year");
            expect(results.length).toBe(2);
            expect(stringify(results)).toBe(stringify(getTestResultsResponse.testResults));
        }));
        it("should create an instance when configuration is valid (gentrace.ai host)", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
        ...
        it("should return pipelines when invoking the /api/pipelines API", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
            });
        ...
        it("should return filtered pipelines when invoking the /api/pipelines API", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
            });
        ...
        it("should prioritize GENTRACE_RESULT_NAME over GENTRACE_RUN_NAME", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it("should still read GENTRACE_RUN_NAME", () => __awaiter(void 0, void 0, void 0, function* () {
            process.env.GENTRACE_RUN_NAME = "run-name";
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
        ...
        it("should read GENTRACE_RESULT_NAME", () => __awaiter(void 0, void 0, void 0, function* () {
            process.env.GENTRACE_RESULT_NAME = "result-name";
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
        ...
        it("should read resultName over runNam", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
                branch: "test-branch-init",
        ...
        it("should still read runName", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
                branch: "test-branch-init",
        ...
        it("should read resultName", () => __awaiter(void 0, void 0, void 0, function* () {
            init({
                apiKey: "gentrace-api-key",
                basePath: "https://gentrace.ai/api",
                branch: "test-branch-init",
