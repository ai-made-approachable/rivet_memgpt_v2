        ...
        return wrapAsync(function dispatchHttpRequest(resolve, reject, onDone) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                function abort(reason) {
                    emitter.emit("abort", !reason || reason.type
                    ...
                    if (responseType === "stream") {
                        ...
                        responseStream.on("data", function handleStreamData(chunk) {
                            ...
                            if (config.maxContentLength > -1 &&
                                ...
                                reject(new AxiosError("maxContentLength size of " +
                                    config.maxContentLength +
                                    " exceeded", AxiosError.ERR_BAD_RESPONSE, config, lastRequest));
                            }
                        });
                        responseStream.on("aborted", function handlerStreamAborted() {
                            ...
                            const err = new AxiosError("maxContentLength size of " +
                                config.maxContentLength +
                                " exceeded", AxiosError.ERR_BAD_RESPONSE, config, lastRequest);
                ...
                if (config.timeout) {
                    ...
                    req.setTimeout(timeout, function handleRequestTimeout() {
                        ...
                        reject(new AxiosError(timeoutErrorMessage, transitional.clarifyTimeoutError
                            ? AxiosError.ETIMEDOUT
                            : AxiosError.ECONNABORTED, config, req));
                        abort();
                    });
                }
                // Send the request
