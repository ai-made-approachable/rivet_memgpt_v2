...
const V1ApiAxiosParamCreator = function (configuration) {
    return {
        ...
        v1RunPost: (runRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1RunPost", "runRequest", runRequest);
        ...
        v1TestCasePatch: (updateTestCase, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1TestCasePatch", "updateTestCase", updateTestCase);
            const localVarPath = `/v1/test-case`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common.DUMMY_BASE_URL);
            let baseOptions;
        ...
        v1TestCasePost: (v1TestCasePostRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1TestCasePost", "v1TestCasePostRequest", v1TestCasePostRequest);
            const localVarPath = `/v1/test-case`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common.DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common.serializeDataIfNeeded(v1TestCasePostRequest, localVarRequestOptions, configuration);
            return {
                url: common.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        v1TestResultGet: (pipelineSlug, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1TestResultGet", "pipelineSlug", pipelineSlug);
        ...
        v1TestResultIdGet: (id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1TestResultIdGet", "id", id);
        ...
        v1TestResultPost: (v1TestResultPostRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1TestResultPost", "v1TestResultPostRequest", v1TestResultPostRequest);
            const localVarPath = `/v1/test-result`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common.DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common.serializeDataIfNeeded(v1TestResultPostRequest, localVarRequestOptions, configuration);
            return {
                url: common.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        v1TestResultSimplePost: (v1TestResultSimplePostRequest, options = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            common.assertParamExists("v1TestResultSimplePost", "v1TestResultSimplePostRequest", v1TestResultSimplePostRequest);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = Object.assign(Object.assign(Object.assign({}, localVarHeaderParameter), headersFromBaseOptions), options.headers);
            localVarRequestOptions.data = common.serializeDataIfNeeded(v1TestResultSimplePostRequest, localVarRequestOptions, configuration);
            return {
                url: common.toPathString(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        v1TestResultStatusGet: (id, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'id' is not null or undefined
            common.assertParamExists("v1TestResultStatusGet", "id", id);
 ...
 * @extends {BaseAPI}
 */
class V1Api extends base.BaseAPI {
    /**
     *
     * @summary Upload an image file
     * @param {string} [org] (If not using an organization API Key) the ID of the organization
...
//# sourceMappingURL=v1-api.js.map
