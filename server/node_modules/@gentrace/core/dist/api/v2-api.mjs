...
import { DUMMY_BASE_URL, setBearerAuthToObject, setSearchParams, toPathString, createRequestFunction } from '../common.mjs';
...
export { V2Api, V2ApiAxiosParamCreator, V2ApiFactory, V2ApiFp };
//# sourceMappingURL=v2-api.mjs.map
